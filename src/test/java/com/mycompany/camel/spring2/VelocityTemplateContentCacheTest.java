...
public class VelocityTemplateContentCacheTest extends CamelTestSupport {
  ...
  //      Set<ObjectName> objNameSet = mbeanServer.queryNames(new ObjectName("org.apache.camel:type=endpoints,name=\"velocity:*contentCache=true*\",*"), null);
        Set<ObjectName> objNameSet = mbeanServer.queryNames(new ObjectName("org.apache.camel:type=*,name=\"recipientList*\",*"), null);
        ObjectName managedObjName = new ArrayList<ObjectName>(objNameSet).get(1);
...
// works fine now:
//                from("direct:a").to("velocity://org/apache/camel/component/stringtemplate/hello.tm?contentCache=false").to("mock:result");
//
//                from("direct:b").to("velocity://org/apache/camel/component/stringtemplate/hello.tm?contentCache=true").to("mock:result");
